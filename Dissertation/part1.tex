...
\[
  \po = (p^0_1, p^0_2, \ldots, p^0_\kappa),\quad \sum_{i=1}^\kappa p^0_i = 1.
\]
...
Обозначим $h_t = \left((i_1, j_1), (i_2, j_2), \ldots, (i_t, j_t)\right)$ историю ходов игроков на шаге $t$.
Также обозначим через $H_t$ множество всех историй, которые могли реализоваться на шаге $t$. 
...
Отметим, что, как показано в монографии Аумана, Машлера~\cite{aumann95}, достаточно рассматривать только стратегии, которые зависят только от предыдущих ходов игрока~1 и не зависят от ходов игрока~2.
...
\section{Формальное определение игры $\mathbf{G^m_n(p)}$}\label{ch1:formal-def}
